        ...
        <div className="login-content">
          ...
          <div className="row">
            ...
            <div className="social-btn-2">
              <a className="fb" href="#top">
                <i className="ion-social-facebook"></i>Facebook
              </a>
              <a className="tw" href="#top">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="hero-ct">
                <h1> movie listing - list 77777</h1>
        ...
        <div className="container">
          <div className="flex-parent-ft">
            <div className="flex-child-ft item1">
              ...
              <p>
                Call us: <a href="#top">(+01) 202 342 6789</a>
              </p>
            </div>
            ...
            <div className="flex-child-ft item4">
              ...
              <ul>
                ...
                <li>
                  <a href="#top">Watchlist</a>
                </li>
                <li>
                  <a href="#top">Collections</a>
                </li>
                <li>
                  <a href="#top">User Guide</a>
                </li>
              </ul>
            </div>
