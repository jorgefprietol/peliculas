                        ...
                        <div class="blog-detail-ct">
                            ...
                            <div class="flex-it share-tag">
                                <div class="social-link">
                                    <h4>Share it</h4>
                                    <a href="#top"><i class="ion-social-facebook"></i></a>
                                    <a href="#top"><i class="ion-social-twitter"></i></a>
                                    <a href="#top"><i class="ion-social-googleplus"></i></a>
                                    <a href="#top"><i class="ion-social-pinterest"></i></a>
                                    <a href="#top"><i class="ion-social-linkedin"></i></a>
                                </div>
                                <div class="right-it">
                                    <h4>Tags</h4>
                                    <a href="#top">Gray,</a>
                            ...
                            <div class="comments">
                                ...
                                <div class="cmt-item flex-it">
                                    ...
                                    <div class="author-infor">
                                        <div class="flex-it2">
                                            <h6><a href="#top">Steve Perry</a></h6> <span class="time"> - 27 Mar 2017</span>
                                        </div>
                                        ...
                                        <p><a class="rep-btn" href="#top">+ Reply</a></p>
                                    </div>
                                </div>
                                <div class="cmt-item flex-it reply">
                                    ...
                                    <div class="author-infor">
                                        <div class="flex-it2">
                                            <h6>
                                                <a href="#top">Joss Whedon</a>
                                            </h6> 
                                            <span class="time"> - 27 Mar 2017</span>
                                        </div>
                                        <p>Prince died not long after the 2016 Rock Hall ceremony, so this year's edition 
                                            featured Lenny Kravitz and a full gospel choir performing a swamp-funk take on When Doves Cry.
                                        </p>
                                    </div>
                                </div>
                                <div class="cmt-item flex-it reply">
                                    ...
                                    <div class="author-infor">
                                        <div class="flex-it2">
                                            <h6><a href="#top">Dave McNary</a></h6> <span class="time"> - 27 Mar 2017</span>
                                        </div>
                                        <p>Blue Sky Studios is one of the world’s leading digital animation movie studios 
                                            and we are proud of their commitment to stay and grow in Connecticut.
                                        </p>
                                    </div>
                                </div>
                                <div class="cmt-item flex-it">
                                    ...
                                    <div class="author-infor">
                                        <div class="flex-it2">
                                            <h6><a href="#top">Margot Robbie</a></h6> <span class="time"> - 27 Mar 2017</span>
                                        </div>
                                        <p>Joan Baez was the sharpest of the Rock Hall inductees, singing about deportees and 
                                            talking social activism as well as joking about her age and the likelihood that a good portion of the Barclays. 
                                        </p>
                                        <p><a class="rep-btn" href="#top">+ Reply</a></p>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="sidebar">
                            ...
                            <div class="sb-cate sb-it">
                                ...
                                <ul>
                                    <li><a href="#top">Awards (50)</a></li>
                                    <li><a href="#top">Box office (38)</a></li>
                                    <li><a href="#top">Film reviews (72)</a></li>
                                    <li><a href="#top">News (45)</a></li>
                                    <li><a href="#top">Global (06)</a></li>
                                </ul>
                            </div>
                            <div class="sb-recentpost sb-it">
                                <h4 class="sb-title">most popular</h4>
                                <div class="recent-item">
                                    <span>01</span><h6><a href="#top">Korea Box Office: Beauty and the Beast Wins Fourth</a></h6>
                                </div>
                                <div class="recent-item">
                                    <span>02</span><h6><a href="#top">Homeland Finale Includes Shocking Death </a></h6>
                                </div>
                                <div class="recent-item">
                                    <span>03</span><h6><a href="#top">Fate of the Furious Reviews What the Critics Saying</a></h6>
                                </div>
                            </div>
                            <div class="sb-tags sb-it">
                                <h4 class="sb-title">tags</h4>
                                <ul class="tag-items">
                                    <li><a href="#top">Batman</a></li>
                                    <li><a href="#top">film</a></li>
                                    <li><a href="#top">homeland</a></li>
                                    <li><a href="#top">Fast & Furious</a></li>
                                    <li><a href="#top">Dead Walker</a></li>
                                    <li><a href="#top">King</a></li>
