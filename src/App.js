    ...
    <div className="login-content">
        ...
        <div className="row">
            ...
            <div className="social-btn-2">
            	<a className="fb" href="#top"><i className="ion-social-facebook"></i>Facebook</a>
            	<a className="tw" href="#top"><i className="ion-social-twitter"></i>twitter</a>
            </div>
        </div>
    </div>
</div>
<div className="login-wrapper"  id="signup-content">
    <div className="login-content">
        <a href="#top" className="close">x</a>
        <h3>sign up</h3>
        <form method="post" action="#">
            <div className="row">
		...
		<nav className="navbar navbar-default navbar-custom">
				...
				<div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul className="nav navbar-nav flex-child-menu menu-left">
						<li className="hidden">
							<a href="#page-top">ww</a>
						</li>
						<li className="dropdown first">
							<a href="#page-top" className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown">
						...
						<li className="dropdown first">
							<a href="#page-top" className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							movies<i className="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul className="dropdown-menu level1">
								<li className="dropdown">
									<a href="#top" className="dropdown-toggle" data-toggle="dropdown" >Movie grid<i className="ion-ios-arrow-forward"></i></a>
					...
					<ul className="nav navbar-nav flex-child-menu menu-right">
						...
						<li className="loginLink"><a href="#top">LOG In</a></li>
						<li className="btn signupLink"><a href="#top">sign up</a></li>
					</ul>
				</div>
	    </nav>
        ...
        <Pelicula />
				...
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p>Director: <a href="#top">Anthony Russo,</a><a href="#top">Joe Russo</a></p>
						<p>Stars: <a href="#top">Chris Evans,</a> <a href="#top">Samuel L. Jackson,</a> <a href="#top">  Scarlett Johansson</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="#top">Peyton Reed</a></p>
						<p>Stars: <a href="#top">Paul Rudd,</a> <a href="#top"> Michael Douglas</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="#top">Shane Black</a></p>
						<p>Stars: <a href="#top">Robert Downey Jr., </a> <a href="#top">  Guy Pearce,</a><a href="#top">Don Cheadle</a></p>
					</div>
				</div>
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="describe">When Tony Stark's world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.</p>
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
						<p>Director: <a href="#top">Alan Taylor</a></p>
						<p>Stars: <a href="#top">Chris Hemsworth,  </a> <a href="#top">  Natalie Portman,</a><a href="#top">Tom Hiddleston</a></p>
					</div>
				</div>
				<div className="topbar-filter">
					...
					<div className="pagination2">
						...
						<a className="active" href="#top">1</a>
						<a href="#top">2</a>
						<a href="#top"><i className="ion-arrow-right-b"></i></a>
					</div>
				</div>
			</div>
...
<footer className="ht-footer">
	<div className="container">
		<div className="flex-parent-ft">
			<div className="flex-child-ft item1">
				...
				New York, NY 10001</p>
				<p>Call us: <a href="#top">(+01) 202 342 6789</a></p>
			</div>
			<div className="flex-child-ft item2">
				<h4>Resources</h4>
				<ul>
					<li><a href="#top">About</a></li> 
					<li><a href="#top">Blockbuster</a></li>
					<li><a href="#top">Contact Us</a></li>
					<li><a href="#top">Forums</a></li>
			...
			<div className="flex-child-ft item4">
				<h4>Account</h4>
				<ul>
					<li><a href="#top">My Account</a></li> 
					<li><a href="#top">Watchlist</a></li>	
					<li><a href="#top">Collections</a></li>
					<li><a href="#top">User Guide</a></li>
				</ul>
			</div>
			<div className="flex-child-ft item5">
				...
				<a href="#top" className="btn">Subscribe now <i className="ion-ios-arrow-forward"></i></a>
			</div>
		</div>
	</div>
	<div className="ft-copyright">
		...
		<div className="backtotop">
			<p><a href="#top" id="back-to-top">Back to top  <i className="ion-ios-arrow-thin-up"></i></a></p>
		</div>
	</div>
</footer>
</div>
